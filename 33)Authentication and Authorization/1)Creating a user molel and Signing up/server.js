...
//error handler for unghandled rejected promise
process.on('unhandledRejection',(err)=>{

    console.log(err.name,err.message);
    console.log('Unhandeled Rejection Ocurred! Shutting Down....');
    
    //exiting the server gracefully
    server.close(()=>{
    process.exit(1); // 0- uncoaught exception 
    })
